...
const NeomorphicTable = ({ children, type = 1, className, ...props }) => {
  ...
  if (type == 2)
    classNeeded =
      ...
      if(type == 3)
      classNeeded = "bg-gradient-to-br from-[#cacaca] to-[#f0f0f0] shadow-[-10px_-10px_20px_#cacaca,10px_10px_20px_#cacaca,-5px_-5px_10px_#cacaca_inset,5px_5px_10px_#cacaca_inset] border-4 border-[#cacaca]";
